...
function salvar(event, collection) {
  ...
  if (document.getElementById('marca').value === '') { alerta('⚠️É obrigatório informar a marca!', 'warning') }
  ...
  else if (document.getElementById('cor').value < 0 || document.getElementById('cor').value > 300) { alerta('⚠️é obrigatório informar a cor', 'warning') }
